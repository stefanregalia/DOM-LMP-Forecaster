...
## Real-time Hourly LMP Exploration

*(target, goal is to predict this by ~10 am the day before)*
...
## Day-ahead LMP Forecast Exploration

*(benchmark, publishes at ~1:30 pm the day before, derived from ~11 am bid deadline)*
...
| All data | Date features engineered from 'datetime_beginning_ept' (called hour, day-of-week, month, is_weekend, is_holiday) |
